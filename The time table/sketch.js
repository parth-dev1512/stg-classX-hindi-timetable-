...
var button;
var subject;
var button_2L, button_art, button_bio, button_chem,  button_comp, button_cst, button_eco, button_eng1, button_eng2, button_geo, button_his, button_maths, button_phy;
...
function draw() {
  ...
  if(day===0)
  {
    text("It's Sunday!!!",width/2,height/2);
